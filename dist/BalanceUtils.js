...
class BalanceUtils {
    ...
    async checkAndDebitBalance(businessId, action) {
        ...
        let currency = 'ngn';
        let priceList = pricing_1.nairaPriceList;
        const actionCountry = (_a = pricing_1.priceListing[action]) === null || _a === void 0 ? void 0 : _a.country;
        if (actionCountry && business.country &&
            actionCountry !== business.country.toLowerCase()) {
            priceList = pricing_1.usdPriceList;
            currency = 'usd';
        }
        else if (business.country.toLowerCase() === 'kenya') {
            priceList = pricing_1.kePriceList;
            currency = 'kes';
        }
        else if (business.country.toLowerCase() === 'nigeria') {
            priceList = pricing_1.nairaPriceList;
            currency = 'ngn';
        }
        else {
            priceList = pricing_1.usdPriceList;
